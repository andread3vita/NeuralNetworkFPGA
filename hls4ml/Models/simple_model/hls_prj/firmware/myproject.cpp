...
void myproject(
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<fc1_weight_t, 150>(w2, "w2.txt");
        nnet::load_weights_from_txt<fc1_bias_t, 50>(b2, "b2.txt");
        nnet::load_weights_from_txt<fc2_weight_t, 2500>(w5, "w5.txt");
        nnet::load_weights_from_txt<fc2_bias_t, 50>(b5, "b5.txt");
        nnet::load_weights_from_txt<output_weight_t, 150>(w8, "w8.txt");
        nnet::load_weights_from_txt<output_bias_t, 3>(b8, "b8.txt");
        loaded_weights = true;
    }
#endif
