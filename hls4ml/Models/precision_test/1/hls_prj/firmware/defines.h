...
typedef ap_fixed<3,1> bias2_t;
typedef ap_uint<1> layer2_index;
typedef ap_ufixed<3,0,AP_RND_CONV,AP_SAT> layer4_t;
typedef ap_fixed<18,8> relu1_table_t;
typedef ap_fixed<16,6> layer5_t;
typedef ap_fixed<3,1> weight5_t;
typedef ap_fixed<3,1> bias5_t;
typedef ap_uint<1> layer5_index;
typedef ap_ufixed<3,0,AP_RND_CONV,AP_SAT> layer7_t;
typedef ap_fixed<18,8> relu2_table_t;
typedef ap_fixed<16,6> layer8_t;
typedef ap_fixed<3,1> weight8_t;
typedef ap_fixed<3,1> bias8_t;
