...
void NN_precision_2(
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<weight2_t, 60>(w2, "w2.txt");
        nnet::load_weights_from_txt<bias2_t, 20>(b2, "b2.txt");
        nnet::load_weights_from_txt<weight5_t, 400>(w5, "w5.txt");
        nnet::load_weights_from_txt<bias5_t, 20>(b5, "b5.txt");
        nnet::load_weights_from_txt<weight8_t, 60>(w8, "w8.txt");
